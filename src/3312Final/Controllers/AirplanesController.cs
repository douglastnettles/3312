...
namespace _3312Final.Controllers
{
    public class AirplanesController : Controller
    {
        ...
        // GET: Airplanes
        public async Task<IActionResult> Index(string pilot)
        {
        ...
        public async Task<IActionResult> Create([Bind("ID,Pilot,Altitude,FlapSetting,Ice,Rain,RunwayDirection,Snow,TripDistance,Weight,WindDirection,WindSpeed")] Airplane airplane)
        {
